...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   - Each `/specx-checklist` run creates a NEW file (never overwrites existing checklists)
...
**Important**: Each `/specx-checklist` command invocation creates a checklist file using short, descriptive names unless file already exists. This allows:
